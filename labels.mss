...
#place_label[zoom>=8][localrank<=5] {
  text-name: @name;
  ...
  [type='neighbourhood'] {
    ...
    text-character-spacing: 1;
    text-halo-radius: 2;
    text-halo-fill: fadeout(@fill1,50);
    ...
    [zoom=13] {
      text-size: 11;
      text-halo-radius: 2.5;
      text-fill: darken(@fill3, 15);
      text-face-name: @sans_it_bd;
      text-line-spacing: -4;
      }
    [zoom=14] { 
      text-size: 14; 
    ...
    [zoom>=15] { 
      ...
      text-fill: darken(@fill3, 15);
      text-line-spacing: -5;
      text-halo-fill: fadeout(@fill1,30);
      text-face-name: @sans_it_bd;
    }
    [zoom>=16] { 
      text-size: 18; 
